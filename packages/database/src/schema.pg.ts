...
export const accountPaymentMethods = pgTable(
...
export const monthlyBudgetAllocations = pgTable(
...
export const creditCardBillPayments = pgTable(
...
export const reserveGoals = pgTable(
  "reserve_goals",
  {
    id: text("id").primaryKey(),
    ownerId: ownedByUser(),
