...
> [!NOTE]
> O planejamento (orçamento) é definido mensalmente e pode ser associado a uma subcategoria, com detalhamento opcional por conta/fonte e meio de pagamento. O valor planejado pode ser editado inline com atualização em tempo real (_in-place_), mantendo o estado de expansão/recolhimento da árvore.
...
> ```
>
> O comando roda typecheck, lint, testes e build.
